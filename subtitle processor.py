...
def extract_dialog_from_srt(file_path):
    ...
    # A state to keep track of whether the next lines should be treated as dialog
    is_dialogue = False
    for line in content:
        if is_dialogue:
            if line.strip():
...
def process_subtitle_directories(directory, output_file):
    with open(output_file, 'w', encoding='utf-8') as output:
        ...
        for root, dirs, files in os.walk(directory):
            if root.endswith("_subtitles"):  # Ensures we're in a subtitle directory
...
# Path to the directory containing all the modules and subtitle directories
base_directory = '/Users/fides/Documents/MSCS/CS7641-ML/Lectures'
output_file_path = '/Users/fides/Documents/MSCS/CS7641-ML/Lectures/merged.txt'
